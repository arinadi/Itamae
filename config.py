...
# --- Core Secrets ---
TELEGRAM_BOT_TOKEN = os.environ.get('ITAMAE_TELEGRAM_TOKEN')
TELEGRAM_CHAT_ID = os.environ.get('ITAMAE_ADMIN_CHAT_ID')
GEMINI_API_KEY = os.environ.get('ITAMAE_GEMINI_KEY')
